...
$post_social = osman_get_option('osman_single-post-social');
$post_date   = osman_get_option('osman_single-post-date');
$post_footer = osman_get_option('osman_single-post-footer');
$post_tags   = osman_get_option('osman_single-post-tags');
?>
...
<?php if(osman_get_option ('blog_author_bio')) { ?>
