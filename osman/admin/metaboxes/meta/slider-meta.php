...
$rep_fields_posts     = array('osmanslider');
...
function post_gallery_options_so_14445904() 
{
    ...
    wp_nonce_field( 'osmanslider', 'noncename_so_14445904' );
    ?>
    ...
    <div id="dynamic_form">
            ...
            <div class="field_row">
              ...
              <div class="field_left">
                <div class="form_field">
                  ...
                  <input type="hidden" class="meta_image_url" name="gallery[image_url][]" value="<?php $gallery_data['image_url'][$i] ; ?>"/>
                  <input type="hidden" class="meta_image_id" name="gallery[image_id][]" value="<?php $gallery_data['image_id'][$i] ; ?>"/>
                </div>
                <div class="form_field" style="margin-bottom: 20px">
                  <label>Description</label>
                  <textarea class="meta_image_desc" name="gallery[image_desc][]" rows="3" style="width: 100%"><?php  $gallery_data['image_desc'][$i] ; ?></textarea>
                </div>
              ...
              <div class="field_right image_wrap">
                <img src="<?php echo $gallery_data['image_url'][$i] ; ?>" />
              </div>
              <div class="clear" /></div> 
            </div>
            <?php
        ...
        <div class="field_row">
            <div class="field_left">
                <div class="form_field">
                    <!--<label>Image URL</label>-->
                    <input class="meta_image_url" value="" placeholder="Image Url"  name="gallery[image_url][]" />
                    <input class="meta_image_id" value=""  placeholder="Image ID" name="gallery[image_id][]" />
                </div>
                <div class="form_field" style="margin-bottom: 20px">
                    <label>Description</label>
    ...
    <script type="text/javascript">
        function add_image(obj) {
            ...
            fileFrame.on('select', function() {
                ...
                jQuery(parent).find("div.image_wrap").html('<img src="'+selection.url+'" />');
            });
            fileFrame.open();
        };
...
function update_post_gallery_so_14445904( $post_id, $post_object ) 
{
    ...
    // Verify authenticity
    /*if ( !wp_verify_nonce( isset($_POST['noncename_so_14445904']), 'osmanslider' ) )
        return 'error';*/
