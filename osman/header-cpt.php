...
<?php get_template_part( 'loop/cpt-sub-header'); ?>
	<div class="main-content-area">
	<?php $layout_main = osman_get_option('osman-cpt-layout');
	//print_r($layout_main);
	//exit;
